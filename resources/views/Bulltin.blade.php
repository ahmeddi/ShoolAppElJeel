        ...
        <div class="max-w-7xl mx-2">
            <div class="flex flex-col space-y-2 bg-white dark:bg-gray-900 overflow-hidden print:shadow-none  shadow-md p-4 sm:rounded-lg">
                ...
                <div> 
                    ...
                    @if ($classe_moy == 1)
                        @livewire('bulttin-elem',['etud' => $etud,'sem' => $sem,])
                    @else
                        @livewire('bullltin',['etud' => $etud,'sem' => $sem,])
                    @endif
                </div> 
                <div dir="rlt" class=" hidden print:block mt-10 z-10 w-full  font-bold text-sm bottom-28   px-20  text-gray-700 print:dark:text-gray-900   dark:text-gray-100">
