                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1 ">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('att.class') }} :</label>
                          @error('classe') <span class="danger">{{ $message }}</span> @enderror  
                          @error('ex') <span class="danger ">{{ $message }}</span> @enderror  

                        </div>
                        <select    wire:model.defer="classe"   class="inputs  @error('classe') reds @enderror">
                          <option value="">-----</option>
                              @foreach ($Classes as $Prof)
                    ...
                    <div class="flex flex-col space-y-1 ">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels"> {{ __('att.nb') }}  :</label>
                          @error('nb') <span class="danger ">{{ $message }}</span> @enderror  
                        </div>
                        <input wire:model.defer='nb' class="inputs  col-span-2 @error('nb') reds @enderror" type="text"   required  />       
                    </div>
                    <div class="flex flex-col space-y-1 ">
                        <div class="flex justify-between">
                    ...
                    <div class="flex flex-col space-y-1 ">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels"> {{ __('att.hrs') }}  :</label>
