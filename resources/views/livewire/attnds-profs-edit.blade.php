                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    <div class="flex flex-col space-y-1 col-span-2 w-full">
                        <div class="flex justify-between">
                          <label   class="labels">{{ __('att.prof') }}</label>
                    ...
                    <div class="flex flex-col space-y-1  w-full ">
                        <div class="flex justify-between">
                          <label for="eid"  class="labels">{{ __('att.mat') }}  :</label>
                          @error('mat') <span class="danger ">{{ $message }}</span> @enderror  
                        </div>
                        <select wire:model="mat"   class="inputs w-full @error('mat') reds @enderror">
                          <option value="">-----</option>
                              @foreach ($Mats as $Mat)
                   ...
                   <div class="flex flex-col space-y-1 w-full ">
                    <div class="flex justify-between">
                      <label for="eid"  class="labels">{{ __('att.class') }}  :</label>
                      @error('classe') <span class="danger ">{{ $message }}</span> @enderror  
                    </div>
                    <select wire:model="classe" class="inputs w-full @error('classe') reds @enderror">
                      <option value="">-----</option>
                    ...
                    <div class="flex flex-col space-y-1 w-full">
                        ...
                        <input wire:model='date' class="inputs w-full @error('date') reds @enderror" type="date"   required  />       
                    </div>
                    <div class="flex flex-col space-y-1 w-full">
                        <div class="flex justify-between">
