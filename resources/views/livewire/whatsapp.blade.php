    ...
    <div class="flex flex-col space-y-4 px-12 py-2 ">
        <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3   justify-items-center sm:grid-cols-1 ">
            <div class="flex flex-col space-y-1 col-span-2 w-full ">
                ...
                <textarea wire:model='msg' class="textearea h-36 w-full @error('msg') reds @enderror" type="text" required  >
                </textarea>
                {{-- <div class=" w-full flex justify-end mx-1 px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-3 text-teal-600">
        ...
        {{-- <div class=" flex ">
            <input type="file" accept="image/*"  wire:model.defer='phototemp'> 
            @error('phototemp') <span class="danger mx-2 ">{{ $message }}</span> @enderror  
        </div> --}}
