            ...
            <div class="flex flex-col space-y-4 ">
                ...
                <div class="grid lg:grid-cols-2 gap-x-6 gap-y-3 px-12  justify-items-center sm:grid-cols-1 ">
                    ...
                    <div class="flex flex-col space-y-1  w-full ">
                        ...
                        <select wire:model.defer="mat"   class="inputs w-full @error('mat') reds @enderror">
                          <option value="">-----</option>
                              @foreach ($Mats as $Mat)
                   ...
                   <div class="flex flex-col space-y-1 w-full ">
                    ...
                    <div class="flex flex-col space-y-1 w-full">
                        ...
                        <input wire:model.defer='date' class="inputs w-full @error('date') reds @enderror" type="date"   required  />       
                    </div>
                    <div class="flex flex-col space-y-1 w-full">
                        <div class="flex justify-between">
