...
{
    public $etud, $sem, $mats, $results = [], $number, $classe, $tot = 0, $totmat =0, $moy, $classmoy,$class_moy, $tots, $note;
    public $header;
    ...
    private function classMoy()
    {

            $nb = Classement::where('semestre_id', $this->sem->id)
            ->where('classe_id', $this->classe)
            ->count();
